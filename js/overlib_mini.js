...
function ol_content_caption(text, title, close) {
    console.log("ol_content_caption");
    closing = "";
...
function ol_content_background(text, picture, hasfullhtml) {
    console.log("ol_content_background");
    var txt;
    if (hasfullhtml) {
        txt = text;
    } else {
...
function set_background(pic) {
    if (over != null) {
        ...
        console.log("set_background: over is null");
    }
}
...
function placeLayer() {
    ...
    if (over != null)
        ...
        console.log("placeLayer: over is null");
}
...
function layerWrite(txt) {
    ...
    if (ns4) {
        ...
        if (over != null) {
            ...
            console.log("layerWrite: over is null");
        }
    }
}
